...
StreamDeckV1::StreamDeckV1(hid_device* device, String serialNumber) :
	StreamDeck(device, serialNumber, STANDARD_V1, 5, 3, true, 72, 1)
{
...
StreamDeckV1::~StreamDeckV1()
{
}

void StreamDeckV1::sendButtonImageData(int row, int column, Image& img)
{
	writeLock.enter();
