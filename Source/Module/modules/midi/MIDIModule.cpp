...
void MIDIModule::noteOnReceived(const int& channel, const int& pitch, const int& velocity)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(noteOnEventId, Array<var>(channel, pitch, velocity));
}
...
void MIDIModule::noteOffReceived(const int& channel, const int& pitch, const int& velocity)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(noteOffEventId, Array<var>(channel, pitch, velocity));
...
void MIDIModule::controlChangeReceived(const int& channel, const int& number, const int& value)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(ccEventId, Array<var>(channel, number, value));
...
void MIDIModule::programChangeReceived(const int& channel, const int& value)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(programChangeId, Array<var>(channel, value));
}
...
void MIDIModule::pitchWheelReceived(const int& channel, const int& value)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(pitchWheelEventId, Array<var>(channel, value));
}
...
void MIDIModule::channelPressureReceived(const int& channel, const int& value)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(channelPressureId, Array<var>(channel, value));
}
...
void MIDIModule::afterTouchReceived(const int& channel, const int& note, const int& value)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(afterTouchId, Array<var>(channel, note, value));
}
...
void MIDIModule::midiMachineControlCommandReceived(const MidiMessage::MidiMachineControlCommand& type)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(machineControlCommandId, Array<var>((int)type));
}
...
void MIDIModule::midiMachineControlGotoReceived(const int& hours, const int& minutes, const int& seconds, const int& frames)
{
	...
	if (scriptManager->getNumItems() > 0) scriptManager->callFunctionOnAllItems(machineControlGotoId, Array<var>(hours, minutes, seconds, frames));
}
