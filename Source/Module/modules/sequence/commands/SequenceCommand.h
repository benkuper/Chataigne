...
public:
	...
	enum ActionType { PLAY_SEQUENCE, PLAY_SEQUENCE_AT, PLAY_MULTI_SEQUENCES, PAUSE_SEQUENCE, STOP_SEQUENCE, STOP_ALL_SEQUENCES, TOGGLE_SEQUENCE, ENABLE_LAYER, DISABLE_LAYER, TOGGLE_LAYER, SET_TIME, MOVE_TIME, GOTO_CUE, GOTO_PREV_CUE, GOTO_NEXT_CUE, SET_TRIGGER_ENABLED, ADD_TRIGGER, SET_EDITING_SEQUENCE, SET_EDITING_SEQUENCE_AT };
