	...
	manager(_manager)
{
	...
	defManager->add(CommandDefinition::createDef(this, "Trigger", "Add Trigger", &SequenceCommand::create, CommandContext::BOTH)->addParam("type", SequenceCommand::ADD_TRIGGER));
