...
void FlapLoggerUI::handleAsyncUpdate(){
...
void FlapLoggerUI::updateTotalLogRow(){
    totalLogRow=0;
...
const String & FlapLoggerUI::getSourceForRow(int r){
    int count = 0;
    int idx = 0;
    while (count<=r ) {
        if(count==r){
...
const String &  FlapLoggerUI::getContentForRow(int r){
    int count = 0;
    int idx = 0;
...
String  FlapLoggerUI::getTimeStringForRow(int r) {
    int count = 0;
    int idx = 0;
    while (count <= r) {
        if (count == r) {
...
FlapLoggerUI::LogList::LogList(FlapLoggerUI * o) :owner(o)
{
}

int FlapLoggerUI::LogList::getNumRows() {

    return owner->totalLogRow;
};

void FlapLoggerUI::LogList::paintRowBackground (Graphics& g,
                                                int rowNumber,
...
void FlapLoggerUI::LogList::paintCell (Graphics& g,
                                       int rowNumber,
                                       int columnId,
                                       int width, int height,
                                       bool) {
...
void FlapLoggerUI::buttonClicked (Button* b) {
